...
<div class="wrap">
	...
	<form action="<?php echo U('addOther');?>" method="post" id="login">
		<div class="login-box">
			<div class="error"></div>
			<ul>
				<li>
					<span>企业文化</span>
					<textarea name="culture" class="tex" data-editor="news_cont"><?php echo ($list["culture"]); ?></textarea>
				</li>
				<li class="btns-box">
...
<script src="__PUBLIC__/js/lib/base.js"></script>
	...
	<script src="__PUBLIC__/admin/js/xheditor/xheditor-1.1.14-zh-cn.min.js"></script>
	<script src="__PUBLIC__/admin/js/page/editor.js"></script>
