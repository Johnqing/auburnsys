		...
		<div class="sub-wrap fr about-box">
			<div class="m1 s-mt">
				...
				<ul class="breadcrumb">
					...
					<li class="active">历史回顾</li>
				</ul>
			</div>

			<div class="history-box">
				<h3><?php echo ($company["history_tit"]); ?></h3>
				<p><?php echo ($company["history_desc"]); ?></p>
			</div>

			<div class="tabs-box">
				<ul class="tabs">
					<li class="active"><a href="###">奥本历史概况</a></li>
					<li><a href="###">奥本的主要客户</a></li>
				</ul>

				<div class="tabs-cont">
					<table class="table">
						<?php if(is_array($ov_list)): $i = 0; $__LIST__ = $ov_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								<td class="time"><?php echo ($vo["overview_time"]); ?></td>
								<td class="desc"><?php echo ($vo["overview_desc"]); ?></td>
				...
				<div class="tabs-cont hide">
					<table class="table customer-box">
						<?php if(is_array($ct_list)): $i = 0; $__LIST__ = $ct_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								<td class="name"><?php echo ($vo["ct_name"]); ?></td>
								<td class="desc"><?php echo ($vo["ct_desc"]); ?></td>
							</tr><?php endforeach; endif; else: echo "" ;endif; ?>
					</table>
				</div>
...
<script src="__PUBLIC__/js/combo/ui.js"></script>
	...
	<script src="__PUBLIC__/js/combo/about.js"></script>
